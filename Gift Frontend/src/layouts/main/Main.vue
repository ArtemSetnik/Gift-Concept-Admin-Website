...
<template>
    <div class="layout--main" :class="[navbarClasses, footerClasses, {'app-page': isAppPage}]">
        ...
        <the-customizer
            ...
            />
        <vx-sidebar :sidebarItems="sidebarItems" :logo="require('@/assets/images/logo/logo.png')" title="Gift Admin" parent=".layout--main" />
...
import driverSidebarItems from "@/layouts/components/vx-sidebar/sidebarItems.js";
import adminSidebarItems from "@/layouts/components/vx-sidebar/adminSidebarItems.js";
import sellerSidebarItems from "@/layouts/components/vx-sidebar/sellerSidebarItems.js";
...
export default {
    data() {
        return {
            ...
            disableThemeTour: true, //themeConfig.disableThemeTour,
            steps: [
                {
    ...
    computed: {
        sidebarItems() {
          ...
          if(this.$auth.isSellerAuthenticated()) {
            return this.sellerSidebarItems;
          }
          if(this.$auth.isDriverAuthenticated()) {
            return this.driverSidebarItems;
          }
          return [];
        },
        isAppPage() {
