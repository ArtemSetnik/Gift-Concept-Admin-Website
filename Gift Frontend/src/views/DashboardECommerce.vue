        ...
        <div class="vx-row">
            ...
            <div class="vx-col w-full lg:w-1/3">
                <vx-card title="Sessions By Device">
                    ...
                    <div slot="no-body">
                        <vue-apex-charts type=donut height=325 :options="analyticsData.sessionsByDeviceDonut.chartOptions" :series="analyticsData.sessionsByDeviceDonut.series" />
                    </div>
            ...
            <!-- CHAT CARD -->
            <div class="vx-col w-full lg:w-1/3 md:w-1/2 sm:w-1/2">
                            ...
                            <VuePerfectScrollbar ref="chatLogPS" class="scroll-area pt-6 px-6" :settings="settings">
                                <ul ref="chatLog">
                                        <li class="flex items-start" :class="{'flex-row-reverse': msg.isSent, 'mt-4': index}" v-for="(msg, index) in chatMsg" :key="index">
                                            <vs-avatar size="40px" class="m-0 flex-no-shrink" :class="msg.isSent ? 'ml-5' : 'mr-5'" :src="require(`@/assets/images/portrait/small/${msg.senderImg}`)"></vs-avatar>
