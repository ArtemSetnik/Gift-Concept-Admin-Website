	...
	<vx-card title="Parent" code-toggler class="overflow-hidden">
		...
		<div slot="no-body-bottom">
			...
			<div id="parentx-demo-2" style="height: 500px;" class="relative">
				...
				<vs-sidebar parent="#parentx-demo-2" :hidden-background="true"  default-index="1" color="primary" class="sidebarx sidebarpage sidebar-demo-parent" spacer v-model="active">
